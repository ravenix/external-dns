...
var defaultConfig = &Config{
	...
	ManagedDNSRecordTypes:       []string{endpoint.RecordTypeA, endpoint.RecordTypeCNAME, endpoint.RecordTypeMX, endpoint.RecordTypeNS},
}
...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("managed-record-types", "Comma separated list of record types to manage; specify multiple times for multiple record types (default: A, CNAME)").Default(defaultConfig.ManagedDNSRecordTypes...).StringsVar(&cfg.ManagedDNSRecordTypes)
